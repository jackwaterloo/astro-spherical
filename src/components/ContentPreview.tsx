...
export default function ContentPreview({ entry, detailed = false, class: className }: Props) {
  ...
  return (
    ...
    >
      <a
        ...
        data-astro-prefetch
      >
        <div class="blend min-w-[95px] py-1 text-sm uppercase sm:mr-4">{formatDate(data.date)}</div>
